...
namespace WindowsFormsApp1 {
    ...
    public partial class DatabaseDataSet1 : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(string user, string password, string role) {
...
namespace WindowsFormsApp1.DatabaseDataSet1TableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Users` WHERE ((`id_users` = ?) AND ((? = 1 AND `user` IS NULL) OR (`" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Users` (`user`, `password`, `role`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Users` SET `user` = ?, `password` = ?, `role` = ? WHERE ((`id_users` = ?)" +
                " AND ((? = 1 AND `user` IS NULL) OR (`user` = ?)) AND ((? = 1 AND `password` IS " +
                "NULL) OR (`password` = ?)) AND ((? = 1 AND `role` IS NULL) OR (`role` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `id_users`, `user`, `password`, `role` FROM `Users`";
        ...
        public virtual int Delete(int Original_id_users, string Original_user, string Original_password, string Original_role) {
        ...
        public virtual int Insert(string user, string password, string role) {
            if ((user == null)) {
        ...
        public virtual int Update(string user, string password, string role, int Original_id_users, string Original_user, string Original_password, string Original_role) {
            if ((user == null)) {
